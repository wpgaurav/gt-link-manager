...
$method=(new ReflectionClass(GTLM_Analytics_View::class))->getMethod('chart_data');$checks=[];function chart_check($ok,$label){global$checks;$checks[]=['ok'=>(bool)$ok,'check'=>$label];}
