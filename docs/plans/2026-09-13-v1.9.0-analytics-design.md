...
Date: September 13, 2026. Status: original design retained for traceability. Implemented as a test candidate; see [current behavior and verification](../analytics.md). The requested WordPress-time reports supersede the UTC-only UI proposal below.
